...
echo create_ISIMIP_NetCDF_fullprofile.py -p ISIMIP3a -t obsclim -m 20CRv3-W5E5 -c historical -fi 1901 -f 2019
./create_ISIMIP_NetCDF_fullprofile.py -p ISIMIP3a -t obsclim -m 20CRv3-W5E5 -c historical -fi 1901 -f 2019
