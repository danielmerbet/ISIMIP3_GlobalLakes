...
echo create_ISIMIP_NetCDF.py -p ISIMIP3a -t obsclim -m GSWP3-W5E5 -c historical -fi 1901 -f 2019
./create_ISIMIP_NetCDF.py -p ISIMIP3a -t obsclim -m GSWP3-W5E5 -c historical -fi 1901 -f 2019 
