...
echo create_ISIMIP_NetCDF_fullprofile.py -p ISIMIP3a -t counterclim -m 20CRv3-ERA5 -c historical -fi 1901 -f 2021
./create_ISIMIP_NetCDF_fullprofile.py -p ISIMIP3a -t counterclim -m 20CRv3-ERA5 -c historical -fi 1901 -f 2021
