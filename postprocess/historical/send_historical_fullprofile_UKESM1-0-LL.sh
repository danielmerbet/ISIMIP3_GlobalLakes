...
echo create_ISIMIP_NetCDF_fullprofile.py -p ISIMIP3b -t bias-adjusted -m UKESM1-0-LL -c historical -fi 1850 -f 2014
./create_ISIMIP_NetCDF_fullprofile.py -p ISIMIP3b -t bias-adjusted -m UKESM1-0-LL -c historical -fi 1850 -f 2014
