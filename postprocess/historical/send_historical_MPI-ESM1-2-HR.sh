...
echo create_ISIMIP_NetCDF.py -p ISIMIP3b -t w5e5 -m MPI-ESM1-2-HR -c historical -fi 1850 -f 2014
./create_ISIMIP_NetCDF.py -p ISIMIP3b -t w5e5 -m MPI-ESM1-2-HR -c historical -fi 1850 -f 2014
