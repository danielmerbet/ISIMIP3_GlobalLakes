...
echo create_ISIMIP_NetCDF.py -p ISIMIP3b -t w5e5 -m UKESM1-0-LL -c picontrol -fi 1841 -f 2100
./create_ISIMIP_NetCDF.py -p ISIMIP3b -t w5e5 -m UKESM1-0-LL -c picontrol -fi 1841 -f 2100
