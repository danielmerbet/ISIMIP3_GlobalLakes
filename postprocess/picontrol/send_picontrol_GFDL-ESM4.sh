...
echo create_ISIMIP_NetCDF.py -p ISIMIP3b -t w5e5 -m GFDL-ESM4 -c picontrol -fi 1841 -f 2100
./create_ISIMIP_NetCDF.py -p ISIMIP3b -t w5e5 -m GFDL-ESM4 -c picontrol -fi 1841 -f 2100
