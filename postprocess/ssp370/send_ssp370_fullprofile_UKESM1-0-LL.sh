...
echo create_ISIMIP_NetCDF_fullprofile.py -p ISIMIP3b -t bias-adjusted -m UKESM1-0-LL -c ssp370 -fi 2015 -f 2100
./create_ISIMIP_NetCDF_fullprofile.py -p ISIMIP3b -t bias-adjusted -m UKESM1-0-LL -c ssp370  -fi 2015 -f 2100
