...
echo create_ISIMIP_NetCDF.py -p ISIMIP3b -t w5e5 -m MPI-ESM1-2-HR -c ssp585 -fi 2015 -f 2100
./create_ISIMIP_NetCDF.py -p ISIMIP3b -t w5e5 -m MPI-ESM1-2-HR -c ssp585 -fi 2015 -f 2100
