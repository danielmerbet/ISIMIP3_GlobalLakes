...
echo create_ISIMIP_NetCDF_fullprofile.py -p ISIMIP3b -t bias-adjusted -m IPSL-CM6A-LR -c ssp126 -fi 2015 -f 2100
./create_ISIMIP_NetCDF_fullprofile.py -p ISIMIP3b -t bias-adjusted -m IPSL-CM6A-LR -c ssp126 -fi 2015 -f 2100
